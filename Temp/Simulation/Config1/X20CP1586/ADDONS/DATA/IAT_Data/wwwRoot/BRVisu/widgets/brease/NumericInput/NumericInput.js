       ...
       */
        ...
        */
        ...
        function _updateLangDependency(widget) {
            if (brease.language.isKey(widget.getUnit()) || brease.language.isKey(widget.getFormat()) || widget.getInfoCustomizedUnit(widget.getUnit())) {
        ...
        p.getInfoCustomizedUnit = function (unit) {
            ...
            for(var code in unit){
                if(unit[code].includes("http://www.br-automation.com/units")){
                    return true;
                }else{
                    return false;
                }
