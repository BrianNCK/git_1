...
define([
    ...
    'brease/core/Utils',
    'brease/core/Types',
    'widgets/brease/ButtonBar/libs/EditorHandles'
], function (SuperClass, BreaseEvent, Scroller, Enum, Utils, Types, EditorHandles) {
        ...
        if (widget.settings.childPositioning === Enum.ChildPositioning.relative) {
            ...
            $(selector).each(function () {
                ...
                if (widgetState < Enum.WidgetState.INITIALIZED) {
                    ...
                    var widget = brease.callWidget(this.id, 'widget');
        ...
        if (!brease.config.editMode) {
            $(selector).children().each(function () {
                if ($(this).hasClass('remove') !== true) {
                    ...
                    contentSize = parseInt(positionObj.top / scaleFactor) + parseInt($(this).outerHeight(true));
